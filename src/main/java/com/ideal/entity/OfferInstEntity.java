...
public class OfferInstEntity {
	...
	private String OFFER_INST_TYPE;
	private String OFFER_INST_NAME;
	...
	public String toString() {
		return "OfferInstEntity [OFFER_INST_ID=" + OFFER_INST_ID + ", OFFER_ID=" + OFFER_ID + ", CUST_ID=" + CUST_ID
				+ ", OFFER_INST_TYPE=" + OFFER_INST_TYPE + ", OFFER_INST_NAME=" + OFFER_INST_NAME + ", CUST_ORDER_ID="
