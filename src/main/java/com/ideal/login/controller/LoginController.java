 ...
 * secret	string		是	小程序 appSecret   ae7295ace6dee7edff2030bae13258a2     83b152ad0719bed60e46a36fb17a765d
...
//
    ...
    public String sendMsg(){
        ...
        String secret = "83b152ad0719bed60e46a36fb17a765d";
    ...
    public Map<String, Object> loginAregister(String code, String userName, String passWd){
        ...
        user.put("openId", getOpenId(code));
        user.put("registerDate", simpleDateFormat.format(new Date()));
        user.put("contact_address", "上海市浦东新区丁香路750号");
        //未查到用户，注册新用户
        if(null == userInfo ){
            //注册
